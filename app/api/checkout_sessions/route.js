...
// Initialize Stripe with your secret key and specify API version
...
const formatAmountForStripe = (amount, currency) => {
  return Math.round(amount * 100); // Convert to smallest currency unit (e.g., cents)
};

// POST request to create a new Stripe checkout session
...
// GET request to retrieve a checkout session by session_id
